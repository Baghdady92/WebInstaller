...
(() => {
  const DICTS = {
    en: {
      ...
      "install.fileNoDevice": "APK selected, but no device is connected — connect first, then pick the file again",
    ...
    ar: {
      ...
      "install.fileNoDevice": "تم اختيار ملف APK لكن لا يوجد جهاز متصل — اتصل بالجهاز أولاً ثم أعد اختيار الملف",
